...
import com.foxykeep.greendroidlight.image.ChainImageProcessor;
import com.foxykeep.greendroidlight.image.ImageProcessor;
import com.foxykeep.greendroidlight.image.MaskImageProcessor;
import com.foxykeep.greendroidlight.image.ScaleImageProcessor;
import com.foxykeep.greendroidlight.poc.R;
import com.foxykeep.greendroidlight.widget.AsyncImageView;

public final class AsyncImageViewListActivity extends ListActivity implements OnScrollListener {
    ...
    private static final class MyAdapter extends BaseAdapter {
        ...
        private static final String BASE_URL_PREFIX =
                "http://www.cyrilmottier.com/files/greendroid/images/image";
        ...
        private void prepareImageProcessor(Context context) {
            ...
            final int thumbnailRadius = context.getResources().getDimensionPixelSize(
                    R.dimen.thumbnail_radius);
    ...
    private void searchAsyncImageViews(ViewGroup viewGroup, boolean pause) {
        ...
        for (int i = 0; i < childCount; i++) {
            AsyncImageView image = (AsyncImageView) viewGroup.getChildAt(i).findViewById(
                    R.id.async_image);
            if (image != null) {
