...
public class ImageLoader {
    ...
    public ImageLoader(final Context context) {
        ...
        if (sExecutor == null) {
            sExecutor = GDUtils.getExecutorService(context);
        }
    ...
    private class ImageFetcher implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (LogConfig.GD_ERROR_LOGS_ENABLED) {
    ...
    private class ImageHandler extends Handler {
        ...
        private ImageHandler(final String url, final ImageLoaderCallback callback) {
            mUrl = url;
            mCallback = callback;
        }
