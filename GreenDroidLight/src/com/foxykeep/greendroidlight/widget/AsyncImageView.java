...
import com.foxykeep.greendroidlight.image.ImageProcessor;
import com.foxykeep.greendroidlight.image.ImageRequest;
import com.foxykeep.greendroidlight.image.ImageRequest.ImageRequestCallback;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
     ...
     */
    public void setInDensity(final int inDensity) {
        if (mOptions == null) {
    ...
    public void reload(final boolean force) {
        if (mRequest == null && mUrl != null) {
            ...
            if (LogConfig.GD_INFO_LOGS_ENABLED) {
     ...
     * @see ImageProcessor
     */
    public void setImageProcessor(final ImageProcessor imageProcessor) {
    ...
    public void onImageRequestStarted(final ImageRequest request) {
        if (mOnImageViewLoadListener != null) {
            mOnImageViewLoadListener.onLoadingStarted(this);
        }
    }

    public void onImageRequestFailed(final ImageRequest request, final Throwable throwable) {
        mRequest = null;
        if (mOnImageViewLoadListener != null) {
    ...
    public void onImageRequestEnded(final ImageRequest request, final Bitmap image) {
        mBitmap = image;
    ...
    public void onImageRequestCancelled(final ImageRequest request) {
        mRequest = null;
        if (mOnImageViewLoadListener != null) {
