...
public class PagedView extends ViewGroup {
    ...
    private void scrollToPage(int page, final boolean animated) {
    ...
    private void setOffsetX(final int offsetX) {
    ...
    private int getOffsetForPage(final int page) {
        return -(page * getWidth());
    }

    private int getPageForOffset(final int offset) {
        return -offset / getWidth();
    }

    private void recycleViews(final int start, final int end) {
    ...
    private View obtainView(final int position) {
        ...
        if (recycled != null && child != recycled) {
            if (LogConfig.GD_WARNING_LOGS_ENABLED) {
    ...
    private void setupView(final View child, final int position) {
    ...
    private void performStartTracking(final int startMotionX) {
        if (mOnPageChangeListener != null) {
    ...
    private void performPageChange(final int newPage) {
